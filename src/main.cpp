...
void event_stream_handler() {
    ...
    try {
        ...
        Point3D ideal_coord = {rema.ui_telemetry.coords.x, rema.ui_telemetry.coords.y, 0};
        res["TELEMETRY"]["aligned_coords"] = current_session.transform_point_if_aligned(ideal_coord, true);
